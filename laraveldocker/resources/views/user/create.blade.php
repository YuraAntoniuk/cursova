        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <form action="{{route('user.store')}}" method="post">
                    ...
                    <div class="form-group">
                        <input type="password" value="{{old('password_confirmation')}}" name="password_confirmation" class="form-control" placeholder="Підтвердження паролю">
                    </div>
                    <div class="form-group">
                        <input type="text" value="{{old('surname')}}" name="surname" class="form-control" placeholder="Прізвище">
                    </div>
                    <div class="form-group">
                        <input type="text" value="{{old('patronymic')}}" name="patronymic" class="form-control" placeholder="По-батькові">
                    </div>
                    <div class="form-group">
